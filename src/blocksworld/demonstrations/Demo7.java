...
public class Demo7 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Voici les régles d'association extraites d'une base de données de 10000 transactions pour la fréquence minimale %f et la confiance minimale %f :", minFreq, minTrust));
